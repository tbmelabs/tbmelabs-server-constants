...
public class SpringApplicationProfileEnumTest {
  ...
  public void springApplicationProfileProd() {
    ...
    assertThat(SpringApplicationProfileEnum.PROD).hasFieldOrPropertyWithValue(NAME_PROPERTY_NAME, name);
  ...
  public void springApplicationProfileDev() {
    ...
    assertThat(SpringApplicationProfileEnum.DEV).hasFieldOrPropertyWithValue(NAME_PROPERTY_NAME, name);
  ...
  public void springApplicationProfileTest() {
    ...
    assertThat(SpringApplicationProfileEnum.TEST).hasFieldOrPropertyWithValue(NAME_PROPERTY_NAME, name);
  ...
  public void springApplicationProfileNoRedis() {
    ...
    assertThat(SpringApplicationProfileEnum.NO_REDIS).hasFieldOrPropertyWithValue(NAME_PROPERTY_NAME,
        name);
